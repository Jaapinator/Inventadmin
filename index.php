...
?><script><?php include "includes/js/menuswitch.js"; 
	 ...
	 <a class="navbar-brand" href="https://portal.basrt.eu/">Portal</a>
		  ...
		  <div class="collapse navbar-collapse" id="navbarNavDropdown">
			<ul class="navbar-nav">
			  ...
			  <li class="nav-item">
				<a class="nav-link" href="#" data-toggle="modal" data-target="#myModal">Rapport opvragen</a>
			  </li>
...
<div class="modal" id="myModal" role="dialog" style="position:absolute;">
	<div class="modal-dialog">
		<div class="modal-content">
		  <div class="modal-header">
			<h4 class="modal-title">Rapport opvragen</h4>
			<button type="button" class="close" data-dismiss="modal">&times;</button>
		  </div>
		  <div class="modal-body">
			<form method='post' action='rapport.php'>
			<div class="form-group">
				<label class="control-label col-sm-2" for="tabel">Tabel:</label>
				<div class="col-sm-10">
				<select name="tabel">
					<option value="IA_Devices">Apparaten</option>
					<option value="IA_Monitor">Monitoren</option>
					<option value="IA_Software_RG">Software</option>
					<option value="IA_Randapparatuur">Randapparatuur</option>
					<option value="IA_Telefoon">Telefoons</option>
				</select>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="date1">Begindatum:</label>
				<div class="col-sm-10">
					<input type='date' id='picker' name='date1' class='form-control'>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="date2">Einddatum:</label>
				<div class="col-sm-10">
					<input type='date' id='picker' name='date2' class='form-control'>
				</div>
			</div>
